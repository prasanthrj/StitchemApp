...
public class TwitterConnectionService implements SocialConnectionService {
	
	public static final Logger LOGGER = Logger.getLogger(TwitterConnectionService.class);
	...
	public void setSocialUserDetailsManager(SocialUserDetailsService socialUserDetailsManager) {
