...
public interface IDao {
	...
	List fullTextSearch(String searchText, String[] projections, String[] entityFields, Class[] classes, Map<String,Float> boostMap);
	
	
	// LUCENE Indexing .. 
	
	<E extends IEntity> void doIndex(Class<E> entity);
	
	void executeIndexThroJob(Class inEntityClass, List entities);

	void doSingleObjectIndex(IEntity entity);
